...
/*                                                 #+#   #+    #+    #+#      */
/*   Created: 2018/10/03 17:32:39 by ocrossi      #+#   ##    ##    #+#       */
/*   Updated: 2019/05/27 15:08:03 by ocrossi     ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
# define M_LST2 "node number :"
# define M_LST3 "list_content :"
# define M_LINE "-----------------------------------------------------------\n"
...
char						*ft_strnstr(const char *hs, const char *nd,
		size_t len);
...
void						*ft_memcpy(void *est, const void *src, size_t n);
...
t_list						*ft_lstnew(void const *content,
		size_t content_size);
t_glist						*ft_lstgnew(char *str, size_t fd);
void						ft_lstdelone(t_list **alst,
		void (*del)(void*, size_t));
void						ft_lstdel(t_list **alst, void
		(*del)(void*, size_t));
void						ft_lstadd(t_list **alst, t_list *ne);
void						ft_lstgadd(t_glist **alst, t_glist *ne);
void						ft_lstaddend(t_list **alst, t_list *ne);
...
void						ft_lstswap(t_list **node0,
		t_list **node1, t_list **node2);
